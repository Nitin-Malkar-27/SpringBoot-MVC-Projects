	...
	<table border="0" bgcolor="cyan" align="center">
		<tr>
			...
			<td><form:input path="ename" /> <form:errors path="ename"
					cssStyle="color:red" /> <span id="enameErr" style="color: red"></span></td>
		</tr>
		<tr>
			<td>Employee Desg ::</td>
			<td><form:input path="job" /> <form:errors path="job"
					cssStyle="color:red" /><span id="jobErr" style="color: red"></span></td>
		</tr>
		<tr>
			<td>Employee Salary ::</td>
			<td><form:input path="sal" /> <form:errors path="sal"
					cssStyle="color:red" /><span id="salErr" style="color: red"></span></td>
		</tr>
		<tr>
			<td>Employee Dept no ::</td>
			<td><form:input path="deptno" /> <form:errors path="deptno"
					cssStyle="color:red" /><span id="deptnoErr" style="color: red"></span></td>
		</tr>
		<tr>
			...
			<td>
				<button type="reset">
					<img src="images/reset.jpeg" width="100" height="100" />
				</button>
			</td>
		</tr>
		<tr>
