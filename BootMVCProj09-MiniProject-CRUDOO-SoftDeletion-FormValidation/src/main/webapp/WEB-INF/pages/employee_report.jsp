	...
	<c:when test="${!empty pageData}">
		...
		<p style="text-align: center">
			<c:if test="${!pageData.isFirst()}">
				<a href="emp_report?page=0">[first]</a>&nbbsp;&nbsp;
			</c:if>
			...
			<c:if test="${!pageData.isLast() }">
				<a href="emp_report?page=${pageData.getTotalPages()-1 }">[last]</a>&nbp;&nbsp;           
            </c:if>
			<c:if test="${!pageData.isFirst() }">
...
<h1 style="text-align: center">
	<a href="insert_employee">Add Employee <img src="images/add.png" /></a>
</h1>

<br>
<br>
<h1 style="text-align: center">
	<a href="./">home <img src="images/home1.png" />
	</a>
</h1>
